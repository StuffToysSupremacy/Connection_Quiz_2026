...
class Test:
    ...
    def __init__(self, how_many):
        self.test_box = Toplevel()

        self.quiz_frame = Frame(self.test_box)
        self.quiz_frame.grid(padx=10, pady=10)

        self.test_heading_label = Label(self.test_box, text=f"Question 0 of {how_many}",
                                        font=("Arial", 16, "bold"), bg="#C09CD2")

        self.test_heading_label.grid(row=0)
