...
class Quiz:
    ...
    def __init__(self, how_many):
        ...
        # self.longest_streak.set(8)
        # self.current_streak.set(8)

        # # Lowest Result Test Data...
        # self.all_result_list = ["0","0","0","0","0","0","0","1"]
        # self.highest_result_list = ["1","1","1","1","1","1","1","1"]
        # self.qns_passed.set(0)
        # self.longest_streak.set(0)
        # self.current_streak.set(0)
        #
        # # # Random Result Test Data...
        self.all_result_list = ["1","0","1","1","1","1","0", "1"]
        self.highest_result_list = ["1","1","1","1","1","1","1","1"]
        self.qns_passed.set(6)
        # self.longest_streak.set(4)
    ...
    def __init__(self, partner, all_stats_info):
        ...
        for user_result in user_result:
            if user_result == "1":
                ...
                if current_steak > longest_streak:
